    ...
    queryEntitiesByTimestamp: jest.fn().mockResolvedValue([
      {
        ...
        EventType: "eventType",
        Payload:
          '{"type":"farmerApplyData-organisation","message":"Session set for farmerApplyData and organisation.","data":{"reference":"TEMP-931B-C490","organisation":{"sbi":"106401373","farmerName":"Trevor John Hale","name":"M & G Williams","email":"trevorhalec@elahroverts.com.test","address":""}},"raisedBy":"trevorhalec@elahroverts.com.test","raisedOn":"2024-02-15T13:23:57.287Z"}',
      },
    ]),
    connect: jest.fn(),
    writeFile: jest.fn(),
...
describe("miReportFunction", () => {
  ...
  test("should log an error if building the report fails", async () => {
    ...
    await expect(
      async () => await miReportFunction(context, miReportTimer),
